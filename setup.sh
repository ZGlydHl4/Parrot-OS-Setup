...
apt-get -qq install -y --allow-downgrades open-vm-tools open-vm-tools-desktop zsh zsh-autosuggestions libcom-err2=1.46.2-2 freerdp2-x11 nfs-common default-mysql-client dnsenum libssl-dev libkrb5-dev libffi-dev python-dev build-essential jq exploitdb colortest ftp snmp hashid > /dev/null 2&>1
...
echo "[24/34] Installing SecLists"
...
echo "[31/34] Installing oh-my-zsh"
